...
public class TankDestroyRotation extends TankDestroyMethod{
	...
	private var _tankAlreadyRemoved:Boolean;

	public function TankDestroyRotation(tank:Tank) {
		super(tank);
		_tankAlreadyRemoved = false;
	}

	override public function stopDestroying():void {
		_tankAlreadyRemoved = true;
	}
